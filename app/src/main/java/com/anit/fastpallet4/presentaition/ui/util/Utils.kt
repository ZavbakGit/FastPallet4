...
//
//fun getTotalBoxInfoByPalletAction(stringProduct:StringProduct):TotalBoxInfo{
//    var listBox =  stringProduct.boxes
//        .map {
//            BigDecimal(it.weight.toString())
//        }
//    var weightBox =  listBox.fold(BigDecimal(0)){ total: BigDecimal, next: BigDecimal ->total.add(next)}
//
//
//    var listPallet = stringProduct.pallets
//    var weightPall = BigDecimal(0)
//    var counBoxPall = 0
//
//    listPallet.forEach {
//        counBoxPall = counBoxPall + it.countBox
//        weightPall = weightPall.add(BigDecimal(it.count.toString()))
//    }
//
//    return TotalBoxInfo(
//        weight = weightBox.add(weightPall).toFloat(),
//        countBox = listBox.size + counBoxPall,
//        countPallet = stringProduct.pallets.size
//    )
//}
//
